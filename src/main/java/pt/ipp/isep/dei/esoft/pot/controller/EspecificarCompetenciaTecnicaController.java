...
public class EspecificarCompetenciaTecnicaController
{
    ...
    public boolean novaCompetenciaTecnica(String strId, String strDescricaoBreve, String strDescricaoDetalhada, AreaAtividade area)
    {
        try
        {
    ...
    public AreaAtividade areaAtividadeByID(String areaEscolhidaByID) {
         return this.m_oPlataforma.getAreaAtividadeById(areaEscolhidaByID);
    }
    
    public boolean validaAreaAtividade(AreaAtividade area){
        return this.m_oPlataforma.validaAreaAtividade(area);
    }
}
